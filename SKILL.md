...
对标腾讯云 [jimmyyan/cos-vectors-skill](https://clawhub.com/jimmyyan/cos-vectors-skill)，AWS 原生实现。
...
| 维度 | COS 版（jimmyyan） | AWS S3 版（本 Skill） |
|------|-------------------|----------------------|
| 向量存储 | 腾讯云 COS 向量桶 | Amazon S3 Vectors |
| SDK | cos-python-sdk-v5 | boto3 |
| 认证方式 | SecretId / SecretKey | IAM Role / 环境变量 |
| Embedding | ONNX text2vec (768d) | Bedrock Titan v2 (1024d) |
| 最大向量数/索引 | 未知 | 20 亿 |
| 查询延迟 | 毫秒级 | < 100ms |
| 成本 | COS 免费额度 | 比传统向量 DB 低 90% |
